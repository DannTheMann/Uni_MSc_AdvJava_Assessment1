...
/**
 * 
 * The item class is used to store information 
 * regarding to items used in the game such
 * as weight, name and description. Provides
 * methods to create, and return values
 * based on an item.
 * 
 * 
 * @author dja33
...
public class Item {
     ...
     * alternatively use this constructor
     */
    ...
    /**
     * Override toString and provide a detailed
     * explaination of the item in a formatted string
     */
    @Override
